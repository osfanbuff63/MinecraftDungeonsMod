...
public class SlowbowEntity extends AbstractArrow implements ItemSupplier {
	public SlowbowEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(MinecraftDungeonsModModEntities.SLOWBOW, world);
	}
	...
	public static SlowbowEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		SlowbowEntity entityarrow = new SlowbowEntity(MinecraftDungeonsModModEntities.SLOWBOW, entity, world);
	...
	public static SlowbowEntity shoot(LivingEntity entity, LivingEntity target) {
		SlowbowEntity entityarrow = new SlowbowEntity(MinecraftDungeonsModModEntities.SLOWBOW, entity, entity.level);
