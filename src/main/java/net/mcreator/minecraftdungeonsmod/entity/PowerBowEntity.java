...
public class PowerBowEntity extends AbstractArrow implements ItemSupplier {
	public PowerBowEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(MinecraftDungeonsModModEntities.POWER_BOW, world);
	}
	...
	public static PowerBowEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		PowerBowEntity entityarrow = new PowerBowEntity(MinecraftDungeonsModModEntities.POWER_BOW, entity, world);
	...
	public static PowerBowEntity shoot(LivingEntity entity, LivingEntity target) {
		PowerBowEntity entityarrow = new PowerBowEntity(MinecraftDungeonsModModEntities.POWER_BOW, entity, entity.level);
