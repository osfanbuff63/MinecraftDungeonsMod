...
public class TrickbowEntity extends AbstractArrow implements ItemSupplier {
	public TrickbowEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(MinecraftDungeonsModModEntities.TRICKBOW, world);
	}
	...
	public static TrickbowEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		TrickbowEntity entityarrow = new TrickbowEntity(MinecraftDungeonsModModEntities.TRICKBOW, entity, world);
	...
	public static TrickbowEntity shoot(LivingEntity entity, LivingEntity target) {
		TrickbowEntity entityarrow = new TrickbowEntity(MinecraftDungeonsModModEntities.TRICKBOW, entity, entity.level);
