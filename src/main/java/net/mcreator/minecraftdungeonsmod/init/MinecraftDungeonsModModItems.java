...
import net.mcreator.minecraftdungeonsmod.item.ExplodingCrossbowUnique2Item;
...
public class MinecraftDungeonsModModItems {
	...
	public static final Item EXPLODING_CROSSBOW_UNIQUE_2 = register(new ExplodingCrossbowUnique2Item());
