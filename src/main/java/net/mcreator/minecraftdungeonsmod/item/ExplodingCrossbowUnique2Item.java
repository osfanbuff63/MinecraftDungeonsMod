...
public class ExplodingCrossbowUnique2Item extends Item {
	public ExplodingCrossbowUnique2Item() {
		super(new Item.Properties().tab(MinecraftDungeonsModModTabs.TAB_MCD_TAB).durability(503));
		setRegistryName("exploding_crossbow_unique_2");
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ExplodingCrossbowUnique2Entity entityarrow = ExplodingCrossbowUnique2Entity.shoot(world, entity, world.getRandom(), 1f, 4.5, 5);
