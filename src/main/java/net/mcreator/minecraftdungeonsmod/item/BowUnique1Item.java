...
public class BowUnique1Item extends Item {
	public BowUnique1Item() {
		super(new Item.Properties().tab(MinecraftDungeonsModModTabs.TAB_MCD_TAB).durability(100));
		setRegistryName("bow_unique_1");
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					BowUnique1Entity entityarrow = BowUnique1Entity.shoot(world, entity, world.getRandom(), 1.5f, 6, 6);
