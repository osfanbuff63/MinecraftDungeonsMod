...
public class BowUnique2Item extends Item {
	public BowUnique2Item() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).durability(489));
		setRegistryName("bow_unique_2");
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					BowUnique2Entity entityarrow = BowUnique2Entity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
