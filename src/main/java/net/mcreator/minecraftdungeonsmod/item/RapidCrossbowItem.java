...
public class RapidCrossbowItem extends Item {
	public RapidCrossbowItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).durability(384));
		setRegistryName("rapid_crossbow");
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					RapidCrossbowEntity entityarrow = RapidCrossbowEntity.shoot(world, entity, world.getRandom(), 0.5f, 4.5, 5);
