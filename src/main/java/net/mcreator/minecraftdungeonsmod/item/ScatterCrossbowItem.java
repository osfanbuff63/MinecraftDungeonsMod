...
public class ScatterCrossbowItem extends Item {
	public ScatterCrossbowItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).durability(384));
		setRegistryName("scatter_crossbow");
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ScatterCrossbowEntity entityarrow = ScatterCrossbowEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
