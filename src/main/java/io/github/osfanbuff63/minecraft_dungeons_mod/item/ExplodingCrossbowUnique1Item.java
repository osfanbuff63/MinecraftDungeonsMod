...
public class ExplodingCrossbowUnique1Item extends Item {
	public ExplodingCrossbowUnique1Item() {
		super(new Item.Properties().tab(MinecraftDungeonsModModTabs.TAB_MCD_TAB).durability(100));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ExplodingCrossbowUnique1Entity entityarrow = ExplodingCrossbowUnique1Entity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
