...
public class ShortBowEntity extends AbstractArrow implements ItemSupplier {
	public ShortBowEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MinecraftDungeonsModModEntities.SHORT_BOW.get(), world);
	}
	...
	public static ShortBowEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		ShortBowEntity entityarrow = new ShortBowEntity(MinecraftDungeonsModModEntities.SHORT_BOW.get(), entity, world);
	...
	public static ShortBowEntity shoot(LivingEntity entity, LivingEntity target) {
		ShortBowEntity entityarrow = new ShortBowEntity(MinecraftDungeonsModModEntities.SHORT_BOW.get(), entity, entity.level);
