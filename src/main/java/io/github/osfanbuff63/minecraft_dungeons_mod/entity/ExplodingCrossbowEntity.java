...
public class ExplodingCrossbowEntity extends AbstractArrow implements ItemSupplier {
	public ExplodingCrossbowEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MinecraftDungeonsModModEntities.EXPLODING_CROSSBOW.get(), world);
	}
	...
	public static ExplodingCrossbowEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		ExplodingCrossbowEntity entityarrow = new ExplodingCrossbowEntity(MinecraftDungeonsModModEntities.EXPLODING_CROSSBOW.get(), entity, world);
	...
	public static ExplodingCrossbowEntity shoot(LivingEntity entity, LivingEntity target) {
		ExplodingCrossbowEntity entityarrow = new ExplodingCrossbowEntity(MinecraftDungeonsModModEntities.EXPLODING_CROSSBOW.get(), entity,
				entity.level);
