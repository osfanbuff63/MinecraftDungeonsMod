...
public class PowerBowEntity extends AbstractArrow implements ItemSupplier {
	public PowerBowEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MinecraftDungeonsModModEntities.POWER_BOW.get(), world);
	}
	...
	public static PowerBowEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		PowerBowEntity entityarrow = new PowerBowEntity(MinecraftDungeonsModModEntities.POWER_BOW.get(), entity, world);
	...
	public static PowerBowEntity shoot(LivingEntity entity, LivingEntity target) {
		PowerBowEntity entityarrow = new PowerBowEntity(MinecraftDungeonsModModEntities.POWER_BOW.get(), entity, entity.level);
